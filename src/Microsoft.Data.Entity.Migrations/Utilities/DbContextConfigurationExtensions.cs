...
namespace Microsoft.Data.Entity.Migrations.Utilities
{
    internal static class DbContextConfigurationExtensions
    {
        ...
        public static string GetMigrationDirectory(this DbContextConfiguration configuration)
        {
            // TODO: throw if a directory was not specified.
            return configuration.GetExtension<RelationalConfigurationExtension>().MigrationDirectory;
        }
    }
}
